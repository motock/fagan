...
| `gpt-oss-20b-high:latest` | `131072` | 2026-09-18 manual sweep (Apple M4, 24GB unified memory) of gpt-oss-20b-high:latest: swept num_ctx 32768, 49152, 65536, 81920, 98304, 114688, 131072; observed 100% GPU usage, resident 12GB→13GB, no swap growth; 131072 is Ollama's hard clamp; values above have no effect (tested up to 1048576). |
