...
from .service_role_config import _set_plan_role_config_impl, _set_role_default_impl
...
class PipelineService:
    ...
    def set_role_default(
        ...
        """
        return _set_role_default_impl(self, role, provider, model)
    ...
    def set_plan_role_config(
        ...
        """
        return _set_plan_role_config_impl(self, plan_name, role, provider, model)
