// ES-module entry point. State, routing, and HTTP helpers were extracted into
// static/app/state.js, static/app/routing.js, and static/app/api.js; this file
// imports them and keeps the rest of the dashboard logic.
import {
  state,
  STATUS_COLUMNS,
  SORT_OPTIONS,
...
// Backward-compat shims: module scope is not global, so re-expose the shared
// state object and value lists on `window` for any out-of-realm consumer.
window.state = state;
