...
- `tdd_split` (optional, default `false`): opts this story into the test-author phase. The dispatcher sets it `true` at runtime once that phase succeeds; a re-ingest resets it to the plan's value.
