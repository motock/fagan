...
| `PIPELINE_NOTIFY_EMAIL_USERNAME` | unset (empty) | SMTP account name, e.g. `you@example.com` |
...
| `PIPELINE_NOTIFY_EMAIL_SUBJECT` | `[pipeline] plan complete: <plan>` | Subject line of the e-mail |
| `PIPELINE_NOTIFY_EMAIL_USE_TLS` | `true` | Use STARTTLS with mandatory certificate verification |
